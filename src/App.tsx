...
const FarmToolsPage = lazy(() => import("./modules/farm-tools/pages/FarmToolsPage"));
        ...
        <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
          ...
          <Routes>
            ...
            <Route
              path="/farm-tools"
              element={
                <Suspense fallback={<div className="pt-32 pb-32 text-center text-sm text-muted-foreground">Loading Farm Tools…</div>}>
                  <FarmToolsPage />
                </Suspense>
              }
            />
